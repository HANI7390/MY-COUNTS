<?php
	...
	*/
	...
	function get_table_groups($skip_authentication = false) {
		...
		$all_groups = ['&#1575;&#1604;&#1602;&#1575;&#1574;&#1605;&#1577; &#1575;&#1604;&#1585;&#1574;&#1610;&#1587;&#1610;&#1577;', '&#1575;&#1604;&#1581;&#1585;&#1603;&#1575;&#1578; &#1608;&#1575;&#1604;&#1593;&#1605;&#1604;&#1575;&#1578;'];
	...
	function get_sql_fields($table_name) {
		$sql_fields = [
			'table1' => "`table1`.`ID` as 'ID', if(`table1`.`field2`,date_format(`table1`.`field2`,'%Y-%m-%d'),'') as 'field2', IF(    CHAR_LENGTH(`table31`.`field2`), CONCAT_WS('',   `table31`.`field2`), '') as 'field3', `table1`.`field4` as 'field4', IF(    CHAR_LENGTH(`table21`.`field2`), CONCAT_WS('',   `table21`.`field2`), '') as 'field5', `table1`.`field6` as 'field6', `table1`.`field7` as 'field7', `table1`.`field14` as 'field14', `table1`.`field8` as 'field8', `table1`.`field9` as 'field9', IF(    CHAR_LENGTH(`table41`.`field2`), CONCAT_WS('',   `table41`.`field2`), '') as 'field10', `table1`.`field11` as 'field11', IF(    CHAR_LENGTH(`table42`.`field2`), CONCAT_WS('',   `table42`.`field2`), '') as 'field12', `table1`.`field13` as 'field13', `table1`.`field16` as 'field16', IF(    CHAR_LENGTH(`table51`.`field2`), CONCAT_WS('',   `table51`.`field2`), '') as 'field17', `table1`.`field24` as 'field24', `table1`.`field18` as 'field18', `table1`.`field19` as 'field19', `table1`.`field20` as 'field20', IF(    CHAR_LENGTH(`table43`.`field2`), CONCAT_WS('',   `table43`.`field2`), '') as 'field21', `table1`.`field25` as 'field25', `table1`.`field23` as 'field23', `table1`.`field22` as 'field22', `table1`.`field26` as 'field26', `table1`.`field29` as 'field29', IF(    CHAR_LENGTH(`table44`.`field2`), CONCAT_WS('',   `table44`.`field2`), '') as 'field27', `table1`.`field28` as 'field28', `table1`.`field15` as 'field15'",
			'table4' => "`table4`.`ID` as 'ID', `table4`.`field2` as 'field2', IF(    CHAR_LENGTH(`table51`.`field2`), CONCAT_WS('',   `table51`.`field2`), '') as 'field3', IF(    CHAR_LENGTH(`table21`.`field2`), CONCAT_WS('',   `table21`.`field2`), '') as 'field4', IF(    CHAR_LENGTH(`table31`.`field2`), CONCAT_WS('',   `table31`.`field2`), '') as 'field19', `table4`.`field15` as 'field15', `table4`.`field16` as 'field16', `table4`.`field12` as 'field12', `table4`.`field14` as 'field14', `table4`.`field5` as 'field5', `table4`.`field6` as 'field6', `table4`.`field9` as 'field9', `table4`.`field17` as 'field17', `table4`.`field18` as 'field18', `table4`.`field7` as 'field7', `table4`.`field8` as 'field8', `table4`.`field10` as 'field10'",
			'table2' => "`table2`.`id` as 'id', `table2`.`field2` as 'field2', `table2`.`field3` as 'field3'",
			'table3' => "`table3`.`id` as 'id', `table3`.`field2` as 'field2'",
			'table5' => "`table5`.`ID` as 'ID', `table5`.`field2` as 'field2', `table5`.`field3` as 'field3', `table5`.`field4` as 'field4', `table5`.`field5` as 'field5', `table5`.`field6` as 'field6'",
		];
