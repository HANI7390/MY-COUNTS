	...
	$lookups = [
		'table1' => [
			...
			'field10' => [
				'parent_table' => 'table4',
				'parent_pk_field' => 'ID',
				'parent_caption' => '`table4`.`field2`',
				'parent_from' => '`table4` LEFT JOIN `table5` as table51 ON `table51`.`ID`=`table4`.`field3` LEFT JOIN `table2` as table21 ON `table21`.`id`=`table4`.`field4` LEFT JOIN `table3` as table31 ON `table31`.`id`=`table4`.`field19` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
